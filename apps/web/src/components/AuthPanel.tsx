...
export default function AuthPanel() {
  ...
  const handleSignIn = async (event: FormEvent) => {
    ...
    resetMessages();
    setBusy(true);
    const { error: signInError } = await signInWithPassword(login.trim(), password);
    setBusy(false);
    if (signInError) {
      ...
      <div className="auth-card-header">
        ...
        <p className="auth-subtitle">
          {mode === 'confirm'
            ...
            : mode === 'signup'
              ? 'Register for the Assetcues SLA support console.'
              : 'Sign in to the Assetcues SLA support console.'}
        </p>
      </div>
      ...
      {mode === 'confirm' ? (
        <div className="auth-form">
          <div className="auth-confirm-steps">
            ...
            <p><strong>2.</strong> Click the confirmation link in that email</p>
            <p><strong>3.</strong> Come back here and sign in with your username and password</p>
          </div>
          <button
